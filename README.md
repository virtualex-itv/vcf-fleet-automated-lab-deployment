...
* [Sample Execution](#sample-execution)
    * [Deploy Nested ESX and VCF Installer VMs](#deploy-nested-esx-and-vcf-installer-vms)
    * [Deploy VCF Fleet with Management Domain](#deploy-vcf-fleet-with-management-domain)
    * [Deploy VCF Workload Domain](#deploy-vcf-workload-domain)

## Description

This script makes it very easy for anyone to deploy a "basic" VMware Cloud Foundation (VCF) 9.x Fleet in a Nested Lab environment for learning and educational purposes.
...
There is additional verbose logging that outputs as a log file in your current working directory **vcf-9-lab-deployment-XXX.log**
...
### Deploy Nested ESX and VCF Installer VMs
...
### Deploy VCF Fleet with Management Domain
